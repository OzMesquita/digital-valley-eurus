...
-- object: n2s | type: ROLE --
-- DROP ROLE IF EXISTS n2s;
CREATE ROLE n2s WITH 
	CREATEDB
	CREATEROLE
	INHERIT
	LOGIN
	ENCRYPTED PASSWORD '********';
-- ddl-end --
COMMENT ON ROLE n2s IS 'Usuário para o time de desenvolvimento N2S.';
-- ddl-end --

-- object: darwin | type: ROLE --
-- DROP ROLE IF EXISTS darwin;
CREATE ROLE darwin WITH 
	CREATEDB
	CREATEROLE
	INHERIT
	LOGIN
...
-- object: sara | type: ROLE --
-- DROP ROLE IF EXISTS sara;
CREATE ROLE sara WITH 
	CREATEDB
	CREATEROLE
	INHERIT
	LOGIN
...
-- object: n2sguard | type: ROLE --
-- DROP ROLE IF EXISTS n2sguard;
CREATE ROLE n2sguard WITH 
	CREATEDB
	CREATEROLE
	INHERIT
	LOGIN
...
-- object: academus | type: ROLE --
-- DROP ROLE IF EXISTS academus;
CREATE ROLE academus WITH 
	CREATEDB
	CREATEROLE
	INHERIT
	LOGIN
