...
<<<<<<< Updated upstream:EncontrosUniversitarios/app/src/main/java/ufc/russas/encontrosuniversitarios/view/fragment/CadastroUsuarioFragment.java
...
import ufc.russas.encontrosuniversitarios.viewmodel.UserRegistrationViewModel;
>>>>>>> Stashed changes:EncontrosUniversitarios/app/src/main/java/ufc/russas/encontrosuniversitarios/view/fragment/UserRegistrationFragment.java
...
=======
                if (userRegistrationViewModel.getVerificacaoMatricula().getValue() != null) {

                    userRegistrationViewModel.cadastrarUsuario(txtName.getText().toString(), edtMatricula.getText().toString(),
                            edtEmail.getText().toString(), edtSenha.getText().toString(), new UserRegistrationListener() {
                                @Override
                                public void onSuccess(String message) {
                                    Toast.makeText(getContext(), message, Toast.LENGTH_LONG).show();
                                    navitageToLoginFragment();
...
>>>>>>> Stashed changes:EncontrosUniversitarios/app/src/main/java/ufc/russas/encontrosuniversitarios/view/fragment/UserRegistrationFragment.java
        ...
        userRegistrationViewModel.getVerificacaoMatricula().observe(this, new Observer<MatriculaVerification>() {
            @Override
<<<<<<< Updated upstream:EncontrosUniversitarios/app/src/main/java/ufc/russas/encontrosuniversitarios/view/fragment/CadastroUsuarioFragment.java
...
=======
            public void onChanged(MatriculaVerification usuario) {
                if (usuario != null) {
                    txtName.setText(usuario.getData().getName());
>>>>>>> Stashed changes:EncontrosUniversitarios/app/src/main/java/ufc/russas/encontrosuniversitarios/view/fragment/UserRegistrationFragment.java
        ...
        verificarFrequencia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                userRegistrationViewModel.realizarValidacao(new VerificacaoMatriculaListener() {
                    @Override
